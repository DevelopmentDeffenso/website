...
export default function CEH() {
    const [formData, setFormData] = useState({
        name: '',
        email: '',
        subject: 'Certified Ethical Hacker (CEH)',
        message: ''
    });
    ...
    const modules = [
        {
            title: "Module 1: Hacking Methodologies",
            italic: '"The systematic approach to compromise."',
            topics: ["Footprinting & Reconnaissance", "Network Scanning", "Enumeration Techniques"]
        },
        {
            title: "Module 2: System Hacking",
            italic: '"Breaking through the perimeter."',
            topics: ["Vulnerability Analysis", "Malware Threats & Analysis", "Sniffing & Social Engineering"]
        },
        {
            title: "Module 3: Cloud & IoT Security",
            italic: '"Securing modern frontiers."',
            topics: ["Cloud Computing Attacks", "IoT Hacking Scenarios", "OT & ICS Security"]
        },
        {
            title: "Module 4: Cryptography",
            italic: '"The science of secrets."',
            topics: ["Encryption Algorithms", "PKI Implementation", "Cryptanalysis Tools"]
        }
    ];
        ...
        <div className="bg-grid relative min-h-screen bg-[#050505] text-white font-sans overflow-x-hidden">
            ...
            <header className="pt-40 pb-20 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                <div className="relative z-10">
                    <span className="px-3 py-1 bg-green-500/10 text-green-400 border border-green-500/20 text-[10px] font-cyber rounded-full uppercase tracking-wider mb-6 inline-block">
                        Course ID: 004 | Certification
                    </span>
                    <h1 className="text-5xl md:text-7xl font-cyber font-bold mb-6">
                        Certified Ethical <br />
                        <span className="text-green-500">Hacker</span>
                    </h1>
                    <p className="text-gray-400 text-lg leading-relaxed mb-8">
                        The industry gold standard. Master the same tools and techniques used by hackers to build a world-class defensive mindset.
                    </p>
                ...
                <div className="glass-card rounded-[20px] p-10 border-t-4 border-t-green-500 relative z-10">
                    <div className="space-y-6">
                        ...
                        <div className="flex justify-between border-b border-white/5 pb-4">
                            ...
                            <span className="text-white font-bold">iLabs Hands-on Access</span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-gray-500 font-cyber text-xs uppercase tracking-widest">Mentorship</span>
                            <span className="text-white font-bold">Exam Prep Included</span>
                        </div>
                    </div>
                </div>
            </header>
            ...
            <section className="py-24 px-6 relative z-10">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-500">Industry-recognized hacking methodologies.</p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        {modules.map((module, idx) => (
                            <div key={idx} className="glass-card p-10 rounded-[20px] group transition-all border-l-4 border-l-transparent hover:border-l-green-500 hover:bg-green-500/5">
                                <h3 className="font-cyber text-green-500 mb-2">{module.title}</h3>
            ...
            <section className="py-24 px-6 text-center relative z-10 mt-20 mb-20">
                ...
                <div className="max-w-4xl mx-auto flex flex-wrap justify-center gap-6">
                    {roles.map((role, idx) => (
                        <span key={idx} className="glass-card px-10 py-5 rounded-[20px] text-[12px] font-cyber tracking-[0.2em] text-green-400 uppercase">
                            {role}
                        </span>
                    ))}
                </div>
            ...
            <section className="py-24 px-6 relative z-10 max-w-4xl mx-auto mb-32">
                <div className="text-center mb-16">
                    ...
                    <p className="text-gray-500">Get certified and boost your career.</p>
                </div>

                <div className="glass-card p-10 rounded-[30px] bg-[#0f0f0f]/70 backdrop-blur-3xl border border-white/10 shadow-2xl transition-all hover:border-green-500/30">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-6 py-4 rounded-2xl bg-white/[0.03] border border-white/10 text-white text-sm focus:border-green-500 focus:bg-green-500/5 focus:outline-none transition-all shadow-inner"
                                />
                            </div>
                            <div>
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className="w-full px-6 py-4 rounded-2xl bg-white/[0.03] border border-white/10 text-gray-400 text-sm focus:border-green-500 focus:bg-green-500/5 focus:outline-none transition-all appearance-none cursor-pointer"
                            >
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full px-6 py-4 rounded-2xl bg-white/[0.03] border border-white/10 text-white text-sm focus:border-green-500 focus:bg-green-500/5 focus:outline-none transition-all resize-none shadow-inner"
                            ></textarea>
                        </div>
