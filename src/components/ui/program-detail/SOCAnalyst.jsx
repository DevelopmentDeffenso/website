...
export default function SOCAnalyst() {
    ...
    const modules = [
        {
            title: "Module 1: SIEM Implementation",
            italic: '"Logging and visibility mastery."',
            topics: ["Log Sources & Collection", "Splunk/ELK Fundamentals", "Dashboard Creation"]
        },
        {
            title: "Module 2: Threat Detection",
            italic: '"Spotting the invisible adversary."',
            topics: ["Signature-based Detection", "Behavioral Analysis", "Rule Writing (Sigma/YARA)"]
        },
        {
            title: "Module 3: Incident Handling",
            italic: '"Rapid response playbooks."',
            topics: ["Containment Strategies", "Malware Analysis Basics", "Post-Incident Reporting"]
        },
        {
            title: "Module 4: Security Ops Management",
            italic: '"Optimizing the SOC workflow."',
            topics: ["Threat Intelligence Feeds", "Playbook Automation", "Compliance Reporting"]
        }
    ];
        ...
        <div className="bg-grid relative min-h-screen bg-[#050505] text-white font-sans overflow-x-hidden">
            ...
            <header className="pt-40 pb-20 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                <div className="relative z-10">
                    ...
                    <p className="text-gray-400 text-lg leading-relaxed mb-8">
                        The ultimate program for blue teamers. Master the art of monitoring, detection, and incident response in modern enterprise environments.
                    </p>
                ...
                <div className="glass-card rounded-[20px] p-10 border-t-4 border-t-blue-600 relative z-10">
                    <div className="space-y-6">
                        ...
                        <div className="flex justify-between border-b border-white/5 pb-4">
                            ...
                            <span className="text-white font-bold">40+ Real-world Scenarios</span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-gray-500 font-cyber text-xs uppercase tracking-widest">Mentorship</span>
                            <span className="text-white font-bold">Weekly 1-on-1 Sessions</span>
                        </div>
                    </div>
                </div>
            </header>
            ...
            <section className="py-24 px-6 relative z-10">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-500">From monitoring logs to advanced threat hunting.</p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        {modules.map((module, idx) => (
                            <div key={idx} className="glass-card p-10 rounded-[20px] group transition-all border-l-4 border-l-transparent hover:border-l-blue-600 hover:bg-blue-600/5">
                                <h3 className="font-cyber text-blue-600 mb-2">{module.title}</h3>
            ...
            <section className="py-24 px-6 relative z-10 max-w-4xl mx-auto mb-32">
                <div className="text-center mb-16">
                    ...
                    <p className="text-gray-500">Start your journey as a SOC professional.</p>
                </div>

                <div className="glass-card p-10 rounded-[30px] bg-[#0f0f0f]/70 backdrop-blur-3xl border border-white/10 shadow-2xl transition-all hover:border-blue-600/30">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-6 py-4 rounded-2xl bg-white/[0.03] border border-white/10 text-white text-sm focus:border-blue-600 focus:bg-blue-600/5 focus:outline-none transition-all shadow-inner"
                                />
                            </div>
                            <div>
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className="w-full px-6 py-4 rounded-2xl bg-white/[0.03] border border-white/10 text-gray-400 text-sm focus:border-blue-600 focus:bg-blue-600/5 focus:outline-none transition-all appearance-none cursor-pointer"
                            >
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full px-6 py-4 rounded-2xl bg-white/[0.03] border border-white/10 text-white text-sm focus:border-blue-600 focus:bg-blue-600/5 focus:outline-none transition-all resize-none shadow-inner"
                            ></textarea>
                        </div>
